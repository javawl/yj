        ...
        $.ajax({
            ...
            success:function (result) {
                ...
                if (page == 1){
                    ...
                    $("#page").append('<td><a href="'+url+'/show_lottery_draw.jsp?page=1&size='+size+'">第一页</a></td>');
                }
                var ff = 0;
                var f = 0;
                if (page > 4){
                ...
                for(var z = f; z < page_no; z++){
                    ...
                    if (no == page){
                        ...
                        $("#page").append('<td><a href="'+url+'/show_lottery_draw.jsp?page='+no+'&size='+size+'">'+no+'</a></td>');
                    }
                    if (ff == 8)break;
                    ff++;
                }
                ...
                if (page == page_no){
                    ...
                    $("#page").append('<td><a href="'+url+'/show_lottery_draw.jsp?page='+page_no+'&size='+size+'">最后一页</a></td>');
                }
