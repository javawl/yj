...
<head>
    ...
    <script>
        ...
        function pic(){
            ...
            if ($("#reserved").val().length === 0){
                alert("虚拟预约用户数不能为空！");
                return;
            }
            var formData = new FormData();
            formData.append('enroll_st', $("#enroll_st").val());
            formData.append('st', $("#st").val());
            formData.append('et', $("#et").val());
            formData.append('reserved', $("#reserved").val());
            formData.append('virtual', $("#virtual").val());
            $.ajax({
                url:url+"/admin/upload_read_challenge.do",
                type:'POST',
                data:formData,
                dataType:'json',
                processData: false,
    ...
    <center style="margin-top: 15%;">
        ...
        <table>
            ...
            <tr>
                ...
                <td align="left">
                    <input type="text" id="enroll_st">  (注意！！格式是xxxx-xx-xx)
                </td>
            </tr>
            <tr>
                <td align="left">
