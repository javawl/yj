...
<script type="text/javascript">
    ...
    var size = 15;
    var all_url = url+"/admin/show_welfare_service.do?page="+page+"&size="+size+"&type="+type;
            ...
            success:function (result) {
                ...
                for(var i = 0; i < data.length; i++){
                    ...
                    $("#daily_data").append('<tr>'+
                            ...
                            '<td>'+data[i]['et']+'</td>'+
                            '<td>'+string2+'</td>'+
                            '<td><div style="max-width: 200px;word-wrap:break-word">'+data[i]['url']+'</div></td>'+
...
<script>
    ...
    function top_f(id) {
        if (confirm("你确定要置顶？")){
            $.ajax({
                url:url+"/admin/change_welfare_service_rank.do",
                type:'POST',
                data:{
                    id:id
                },
